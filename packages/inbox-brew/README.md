...
When `automatic_updates = false`, scheduled checks still update Homebrew metadata so the Inbox remains current, but package upgrades are skipped. Manual source and package actions remain available.
