...
local function load_widget()
	return host.load(root, easybar_root, "inbox-widget-updates")
end
...
local function test_finds_registry_updates_and_ignores_local_packages()
	...
	complete_refresh(state, "widget-updates-installed", "widget-updates-registry")
...
local function test_update_runs_the_package_installer_and_rechecks()
	...
	complete_refresh(state, "widget-updates-current", "widget-updates-registry")
...
local function test_invalid_registry_retains_the_last_snapshot()
	...
	complete_refresh(state, "widget-updates-installed", "widget-updates-malformed")
...
print("EasyBar package updates inbox regression checks passed")
